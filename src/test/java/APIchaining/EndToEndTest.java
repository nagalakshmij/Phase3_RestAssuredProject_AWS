...
public class EndToEndTest 
{
	...
	Response response;
	String BaseURI= "http://54.80.0.99:8088/employees";
	@Test
	public void test1()
	{
		...
		// to update the data
		response=PostMethod("amogh", "gadiyaram","1000","sss@gmail.com");
		...
		response=PutMethod(EmpId,"tim","US","1000","rick@gmail.com");

		Assert.assertEquals(response.getStatusCode(), 200);
		Jpath=response.jsonPath();
		Assert.assertEquals(Jpath.get("firstName"), "tim");
